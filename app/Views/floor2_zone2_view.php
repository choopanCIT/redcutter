...
<html>
	...
	<a href="<?php echo site_url('home'); ?>" class="btn btn-primary">กลับหน้าหลัก</a></p>
		...
		<div class="container">
		<center>
		<h6> จองโต๊ะ (ชั้น 2) zone2  : กรุณาเลือกโต๊ะเพื่อจอง</h6>
		<h7></h7>
		</center><br>
			<div class="row justify-content-center">
				<div class="col-12 col-sm-8">
					<div class="col-12 col-sm-12">
						<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="519">519</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="517">517</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="515">515</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="513">513</div>
			</div>
			<div class="row justify-content-center" style="margin-top:6%">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="509">509</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="507">507</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="505">505</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="503">503</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="501">501</div>
			</div>
			</div>
			</div>
			<div class="col-sm">
