...
<html>
	...
	<a href="<?php echo site_url('home'); ?>" class="btn btn-primary">กลับหน้าหลัก</a></p>
		...
		<div class="container">
		<center>
		<h6> จองโต๊ะ (ชั้น 2) zone3  : กรุณาเลือกโต๊ะเพื่อจอง</h6>
		<h7></h7>
		</center><br>
			<div class="row justify-content-center">
				<div class="col-12 col-sm-8">
					<div class="col-12 col-sm-12">
						<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="629">629</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="627">627</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="625">625</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="623">623</div>
			</div>
			<div class="row justify-content-center" style="margin-top:6%">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="619">619</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="617">617</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="615">615</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="613">613</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone5-1" name="611">611</div>
			</div>
			</div>
			</div>
			<div class="col-sm">
