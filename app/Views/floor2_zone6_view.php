...
<html>
	...
	<a href="<?php echo site_url('home'); ?>" class="btn btn-primary">กลับหน้าหลัก</a></p>
		...
		<div class="container">
		<center>
		<h6> จองโต๊ะ (ชั้น 2) zone6  : กรุณาเลือกโต๊ะเพื่อจอง</h6>
		<h7></h7>
		</center><br>
			<div class="row justify-content-center">
				...
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone6-2" name="665">665</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone6-2" name="663">663</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone6-2" name="661">661</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone6-2" name="657">657</div>
			</div>
			</div>
			</div>
			<div class="col-sm">
