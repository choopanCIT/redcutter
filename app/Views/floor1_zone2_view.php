...
<html>
	...
	<a href="<?php echo site_url('home'); ?>" class="btn btn-primary">กลับหน้าหลัก</a></p>
		...
		<div class="container">
		<center>
		<h6> จองโต๊ะ (ชั้น 1) zone2  : กรุณาเลือกโต๊ะเพื่อจอง</h6>
		<h7></h7>
		</center><br>
			<div class="row justify-content-center">
				...
				<div class="col-10 col-sm-11">
					<div class="row justify-content-center">
						<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1" name="137">137</div>
					</div>
					<div class="row justify-content-center" style="margin-top: 30%;">
						<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1" name="141">141</div>
					</div>
					<div class="row justify-content-center" style="margin-top: 30%;">
						<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1" name="143">143</div>
					</div>
			</div>
			</div>
			<div class="col-5 col-sm-4">
			<div class="col-10 col-sm-12">
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="158">158</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="161">161</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="155">155</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="164">164</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="152">152</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="167">167</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="149">149</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="170">170</div>
				</div>
		</div>
	</div>
	<div class="col-sm">
