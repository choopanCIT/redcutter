		...
		<div class="container">
			<div class="row justify-content-center">
				...
				<div class="col-10 col-sm-11">
					<div class="row justify-content-center">
						<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1">137</div>
					</div>
					<div class="row justify-content-center" style="margin-top: 30%;">
						<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1">141</div>
					</div>
					<div class="row justify-content-center" style="margin-top: 30%;">
						<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1">143</div>
					</div>
			</div>
			</div>
			<div class="col-5 col-sm-4">
			<div class="col-10 col-sm-12">
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">158</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">161</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">155</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">164</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">152</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">167</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">149</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2">170</div>
				</div>
		</div>
	</div>
	<div class="col-sm">
