...
<html>
	...
	<div class="jumbotron text-center">
		...
		<div class="container">
		<center>
		<h6> จองโต๊ะ (ชั้น 1) zone5  : กรุณาเลือกโต๊ะเพื่อจอง</h6>
		<h7></h7>
		</center><br>
			<div class="row justify-content-center">
				<div class="col-12 col-sm-8" style="margin-top:5%">
					<div class="col-12 col-sm-12">
						<div class="row justify-content-center">
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone5-2" name="243">243</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone5-2" name="240">240</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone5-2" name="237">237</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone5-2" name="313">313</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone5-2" name="316">316</div>
				<div class="col-1 col-sm-1 d-flex justify-content-center justify-content-md-center" id="Zone5-2" name="319">319</div>
			</div>
			</div>
			</div>
			<div class="col-sm">
