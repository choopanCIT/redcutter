...
<html>
	...
	<a href="<?php echo site_url('home'); ?>" class="btn btn-primary">กลับหน้าหลัก</a></p>
		...
		<div class="container">
		<center>
		<h6> จองโต๊ะ (ชั้น 1) zone6  : กรุณาเลือกโต๊ะเพื่อจอง</h6>
		<h7></h7>
		</center><br>
		 ...
		 <div class="col-8 col-sm-7">
			<div class="col-12 col-sm-12">
				<div class="row justify-content-center">
					<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;"></div>
					<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="366">366</div>
				</div>
		</div>
		<div class="col-12 col-sm-12">
			<div class="row justify-content-center">
				<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="364">364</div>
				<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;"></div>
			</div>
	</div>
	<div class="col-12 col-sm-12">
		<div class="row justify-content-center">
			<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;" ></div>
			<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="361">361</div>
		</div>
</div>
<div class="col-12 col-sm-12">
	<div class="row justify-content-center">
		<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="358">358</div>
		<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;"></div>
	</div>
</div>
<div class="col-12 col-sm-12">
	<div class="row justify-content-center">
		<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;"></div>
		<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="355">355</div>
	</div>
</div>

<div class="col-12 col-sm-12">
	<div class="row justify-content-center">
		<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="352">352</div>
		<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;"></div>
	</div>
</div>
<div class="col-12 col-sm-12">
	<div class="row justify-content-center">
		<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;"></div>
		<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="349">349</div>
	</div>
</div>
<div class="col-12 col-sm-12">
	<div class="row justify-content-center">
		<div class="col-5 col-sm-6 d-flex justify-content-center justify-content-md-center" id="Zone6-1" name="346">346</div>
		<div class="col-6 col-sm d-flex justify-content-center justify-content-md-center" style="display: none;"></div>
	</div>
</div>
</div>
