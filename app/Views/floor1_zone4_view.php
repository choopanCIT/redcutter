...
<html>
	...
	<div class="jumbotron text-center">
		...
		<div class="container">
		<center>
		<h6> จองโต๊ะ (ชั้น 1) zone4  : กรุณาเลือกโต๊ะเพื่อจอง</h6>
		<h7></h7>
		</center><br>
			...
			<div class="col-10 col-sm-12">
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="301">301</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="331">331</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-4 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="304">304</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="328">328</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="307">307</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="325">325</div>
				</div>
				<div class="row justify-content-center">
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="310">310</div>
					<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-2" name="322">322</div>
				</div>
			</div>
		</div>
		<div class="col-5 col-sm-4">
		<div class="col-10 col-sm-11">
			<div class="row justify-content-center">
				<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1" name="334">334</div>
			</div>
			<div class="row justify-content-center" style="margin-top: 30%;">
				<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1" name="338">338</div>
			</div>
			<div class="row justify-content-center" style="margin-top: 30%;">
				<div class="col-5 col-sm-4 d-flex justify-content-center justify-content-md-center" id="Zone2-1" name="341">341</div>
			</div>
		</div>
	</div>
	<div class="col-sm">
